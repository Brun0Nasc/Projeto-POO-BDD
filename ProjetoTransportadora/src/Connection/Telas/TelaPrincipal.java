...
import Connection.MySql.DAO.DepositoDAO;
...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    DepositoDAO md = new DepositoDAO();
    ...
    private void initComponents() {
        ...
        pnDeposito = new javax.swing.JPanel();
        jScrollPane7 = new javax.swing.JScrollPane();
        tbDeposito1 = new javax.swing.JTable();
        jLabel8 = new javax.swing.JLabel();
        btConfDep = new javax.swing.JButton();
        btCancDep = new javax.swing.JButton();
        ...
        btSelDep = new javax.swing.JButton();
        btSelCam = new javax.swing.JButton();
        jpnDepositos = new javax.swing.JPanel();
        jLabel6 = new javax.swing.JLabel();
        btnSalvarDeposito = new javax.swing.JButton();
        btnLimparDeposito = new javax.swing.JButton();
        lblId2 = new javax.swing.JLabel();
        lblEndereco2 = new javax.swing.JLabel();
        lblCapacidade3 = new javax.swing.JLabel();
        txtIdDeposito = new javax.swing.JTextField();
        txtEnderecoDeposito = new javax.swing.JTextField();
        txtCapacidadeDeposito = new javax.swing.JTextField();
        jScrollPane5 = new javax.swing.JScrollPane();
        tbDeposito = new javax.swing.JTable();
        btnPesquisarDeposito = new javax.swing.JButton();
        btnAlterarCaminhao1 = new javax.swing.JButton();
        btnExcluirCaminhao1 = new javax.swing.JButton();
        lblCapacidade4 = new javax.swing.JLabel();
        ...
        tbDeposito1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Capacidade", "Endereço"
            }
        ));
        tbDeposito1.setToolTipText("");
        tbDeposito1.setMaximumSize(new java.awt.Dimension(2147483647, 60));
        tbDeposito1.getTableHeader().setResizingAllowed(false);
        tbDeposito1.getTableHeader().setReorderingAllowed(false);
        tbDeposito1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbDeposito1MouseClicked(evt);
            }
        });
        jScrollPane7.setViewportView(tbDeposito1);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setText("Selecionar Depósito Destino");

        btConfDep.setText("Confirmar");
        btConfDep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btConfDepActionPerformed(evt);
            }
        });

        btCancDep.setText("Cancelar");
        btCancDep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCancDepActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnDepositoLayout.createSequentialGroup()
                .addGroup(pnDepositoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnDepositoLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel8))
                    .addComponent(btCancDep))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btConfDep)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnCaminhao.setBounds(200, 0, 420, 210);
        ...
        btSelDep.setText("...");
        btSelDep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSelDepActionPerformed(evt);
            }
        });
        ...
        jpnDepositos.setBackground(new java.awt.Color(126, 133, 176));
        jpnDepositos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jpnDepositosFocusGained(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Gerenciamento de Depósitos");
        ...
        btnSalvarDeposito.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSalvarDepositoActionPerformed(evt);
            }
        });
        ...
        lblEndereco2.setForeground(new java.awt.Color(255, 255, 255));
        lblEndereco2.setText("Endereço:");

        lblCapacidade3.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        lblCapacidade3.setForeground(new java.awt.Color(255, 255, 255));
        lblCapacidade3.setText("ton");

        txtIdDeposito.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N

        txtEnderecoDeposito.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        tbDeposito.setToolTipText("");
        tbDeposito.setMaximumSize(new java.awt.Dimension(2147483647, 60));
        tbDeposito.getTableHeader().setResizingAllowed(false);
        tbDeposito.getTableHeader().setReorderingAllowed(false);
        tbDeposito.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbDepositoMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(tbDeposito);

        btnPesquisarDeposito.setText("Pesquisar");
        btnPesquisarDeposito.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPesquisarDepositoActionPerformed(evt);
            }
        });

        btnAlterarCaminhao1.setText("Alterar");
        btnAlterarCaminhao1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAlterarCaminhao1ActionPerformed(evt);
            }
        });

        btnExcluirCaminhao1.setText("Excluir");
        btnExcluirCaminhao1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExcluirCaminhao1ActionPerformed(evt);
            }
        });

        lblCapacidade4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblCapacidade4.setForeground(new java.awt.Color(255, 255, 255));
        lblCapacidade4.setText("Capacidade:");

        javax.swing.GroupLayout jpnDepositosLayout = new javax.swing.GroupLayout(jpnDepositos);
        jpnDepositos.setLayout(jpnDepositosLayout);
        jpnDepositosLayout.setHorizontalGroup(
            jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jpnDepositosLayout.createSequentialGroup()
                .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpnDepositosLayout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addComponent(lblCapacidade4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCapacidadeDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jpnDepositosLayout.createSequentialGroup()
                        .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpnDepositosLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtIdDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(22, 22, 22)
        ...
        jpnDepositosLayout.setVerticalGroup(
            ...
            .addGroup(jpnDepositosLayout.createSequentialGroup()
                ...
                .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(btnLimparDeposito))
                .addGap(9, 9, 9)
                .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblId2)
                        .addComponent(txtIdDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblEndereco2)
                        .addComponent(txtEnderecoDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(13, 13, 13)
                .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblCapacidade4)
                    .addComponent(txtCapacidadeDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblCapacidade3))
                .addGap(34, 34, 34)
                .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnPesquisarDeposito)
                    .addGroup(jpnDepositosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jTabbedPane1.addTab("Depositos", jpnDepositos);
    ...
    private void btnLimparDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparDepositoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnLimparDepositoActionPerformed

    private void tbDepositoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDepositoMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbDepositoMouseClicked

    private void btnPesquisarDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarDepositoActionPerformed
        // TODO add your handling code here:
        if(txtIdDeposito.getText().equals("")){
            listarDepositos();
        } else {
            pesquisaIdDeposito();
        }
    }//GEN-LAST:event_btnPesquisarDepositoActionPerformed

    private void btnAlterarCaminhao1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarCaminhao1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAlterarCaminhao1ActionPerformed

    private void btnExcluirCaminhao1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirCaminhao1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnExcluirCaminhao1ActionPerformed

    private void jpnDepositosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jpnDepositosFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_jpnDepositosFocusGained

    private void tbDeposito1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDeposito1MouseClicked
        // TODO add your handling code here:
        btConfDep.setEnabled(true);
    }//GEN-LAST:event_tbDeposito1MouseClicked

    private void btConfDepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConfDepActionPerformed
        // TODO add your handling code here:
        carregarCamposDeposito1();
        btConfDep.setEnabled(false);
        pnDeposito.setVisible(false);
    }//GEN-LAST:event_btConfDepActionPerformed

    private void btCancDepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancDepActionPerformed
        // TODO add your handling code here:
        pnDeposito.setVisible(false);
    }//GEN-LAST:event_btCancDepActionPerformed

    private void btSelDepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelDepActionPerformed
        // TODO add your handling code here:
        pnDeposito.setVisible(true);
    }//GEN-LAST:event_btSelDepActionPerformed
    ...
    private void listarDepositos(){
        try {
           DefaultTableModel model = (DefaultTableModel) tbDeposito.getModel();
           DefaultTableModel model1 = (DefaultTableModel) tbDeposito1.getModel();
           model.setNumRows(0);
           model1.setNumRows(0);
           
           ArrayList<Deposito> lista = md.pesquisarDepositos();
           
           for(int i = 0; i < lista.size(); i++){
                   model.addRow(new Object[]{
                   lista.get(i).getId_deposito(),
                   lista.get(i).getCapacidade(),
                   lista.get(i).getEndereco()
               });
           }
           ...
           for(int i = 0; i < lista.size(); i++){
            ...
            JOptionPane.showMessageDialog(null, "Listar Depositos: " + e);
        }
    }
    ...
    private void pesquisaIdDeposito(){
        try {
            ...
            ArrayList<Deposito> lista = md.pesquisarDeposito(Integer.parseInt(txtIdDeposito.getText()));
            ...
            JOptionPane.showMessageDialog(null, "Listar DepositoId: " + e);
        }
    }
    ...
    private void carregarCamposDeposito1(){
    ...
    private void carregarCamposViagem(){
        ...
        txtIdCaminhaoViagem.setText(tbViagens.getModel().getValueAt(setar, 0).toString());
        txtCodCaminhaoViagem.setText(tbViagens.getModel().getValueAt(setar, 1).toString());
        txtNumViagem.setText(tbViagens.getModel().getValueAt(setar, 2).toString());
        txtPesoViagem.setText(tbViagens.getModel().getValueAt(setar, 3).toString());
        txtEnderecoViagem.setText(tbViagens.getModel().getValueAt(setar, 4).toString());
    ...
    private void limparCamposViagens(){
        txtIdCaminhaoViagem.setText("");
        txtCodCaminhaoViagem.setText("");
        txtPesoViagem.setText("");
        txtEnderecoViagem.setText("");
        txtNumViagem.setText("");
    }
    ...
    private javax.swing.JPanel jpnDepositos;
    ...
    private javax.swing.JLabel lblCapacidade3;
    private javax.swing.JLabel lblCapacidade4;
    ...
    private javax.swing.JTextField txtIdDeposito;
